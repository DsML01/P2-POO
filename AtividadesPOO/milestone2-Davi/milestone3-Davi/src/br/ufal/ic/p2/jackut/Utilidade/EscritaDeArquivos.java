...
public class EscritaDeArquivos {
    ...
    public static void salvarRecados(Map<String, User> usuarios) {
        ...
        for (User user : usuarios.values()) {
            // ANTES: for (Recado recado : user.getRecados()) {
            for (Recado recado : user.getCaixaDeEntrada().getRecados()) { // DEPOIS
    ...
    public static void salvarMensagens(Map<String, User> usuarios) {
        ...
        for (User user : usuarios.values()) {
            // ANTES: for (Mensagem mensagem : user.getMensagens()) {
            for (Mensagem mensagem : user.getCaixaDeEntrada().getMensagens()) { // DEPOIS
